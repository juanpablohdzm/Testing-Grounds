...
AMannequin::AMannequin()
{
	...
	//// Create a CameraComponent	 for the third person
	//ThirdPersonCameraComponent = CreateDefaultSubobject<UCameraComponent>(TEXT("ThirdPersonCamera"));
	//ThirdPersonCameraComponent->SetupAttachment(CameraBoom);
	//ThirdPersonCameraComponent->RelativeLocation = FVector(0.0f, 0.0f, 10.0f);

	// Create a CameraComponent	for the first person
